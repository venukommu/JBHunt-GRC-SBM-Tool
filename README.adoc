...
* Download the latest release from here: https://github.com/venukommu/JBHunt-GRC-SBM-Tool/releases/download/v0.0.1/jbhuntgrc-sbm-tool.jar[jbhuntgrc-sbm-tool.jar]
