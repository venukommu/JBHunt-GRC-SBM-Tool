...
IMPORTANT: **GRC SBM Tool - This is a migrator tool which works only for migration services.**
...
. Download the https://github.com/venukommu/SBM-Tool/releases/download/v0.0.2/sbu-tool.jar[sbu-tool.jar]
...
* Download the latest release from here: https://github.com/venukommu/SBM-Tool/releases/download/v0.0.2/sbm-tool.jar[sbm-tool.jar]
* Start the application: `java -jar sbm-tool.jar`
...
* Find the jar in `applications/spring-shell/sbm-tool.jar`
